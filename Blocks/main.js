    ...
    var Queue = (function (_super) {
        ...
        Queue.prototype.generateQueue = function () {
            var _loop_2 = function () {
                var tempBag = [];
                while (tempBag.length < this_2._bagSize) {
                    this_2._bag.forEach(function (i) { return tempBag.push(i.getCopy()); });
                }
                this_2._rng.shuffleArray(tempBag);
                for (var _i = 0, _a = tempBag.slice(0, this_2._bagSize + 1); _i < _a.length; _i++) {
                    var i = _a[_i];
                    this_2._queue.push(i);
                }
            };
            var this_2 = this;
...
(function (M) {
    var MapEditor = (function () {
        function MapEditor() {
            ...
            var lefts = document.createElement("td");
            var rights = document.createElement("td");
            var mapR;
            var _loop_3 = function (i) {
                if (i % this_3._width === 0) {
